...
<h2>Update Branch Details</h2>
	<form action="../updateBranch" name="updateBranch" method="post">
	<input type="number" name="branch_id" value="${branch.id}"hidden>
 	<label>Branch Name: </label><input type="text" name="branch_name" value="${branch.branch_name}"/></br>
 	...
 	<label>Branch Code: </label><input type="text" name="branch_code" value="${branch.branch_code}"/>
 	</br>
 	<label>Branch Address: </label><input type="text" name="branch_address" value="${branch.branch_address}"/>
 	</br>
